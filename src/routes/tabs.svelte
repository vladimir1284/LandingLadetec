			...
			<div class="tab-pane active show" id="tab-1">
				<div class="row">
					...
					>
						...
						<ul>
							<li>
								<i class="ri-check-double-line" /> Ullamco laboris nisi ut aliquip ex ea commodo consequat.
							</li>
							<li>
								<i class="ri-check-double-line" /> Duis aute irure dolor in reprehenderit in voluptate
								velit.
							</li>
							<li>
								<i class="ri-check-double-line" /> Ullamco laboris nisi ut aliquip ex ea commodo consequat.
								Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore
				...
				<div class="row">
					<div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
						...
						<ul>
							...
							<li>
								<i class="ri-check-double-line" /> Provident mollitia neque rerum asperiores dolores
